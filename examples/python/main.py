"""
Example: How to call the jobup-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/jobup-scraper
...
def run_actor():
    """Run the jobup-scraper actor and retrieve results."""
    ...
    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://www.jobup.ch/en/jobs/?location=berne&term=sales"}],
            "maxItems": 10,
